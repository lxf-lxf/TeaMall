    ...
    <div class="Menu_style">
        ...
        <div class="Navigation" id="Navigation">
            <ul class="Navigation_name">
                ...
                <li><a class="nav_on" id="mynav2"  href="goods/SelGoodByType/乌龙茶/1"><span>巴山雀舌</span></a></li>
                <li><a class="nav_on" id="mynav3"  href="goods/SelGoodByType/乌龙茶/1"><span>贡茗</span></a></li>
                <li><a class="nav_on" id="mynav4"  href="goods/SelGoodByType/乌龙茶/1"><span>冠茗</span></a></li>
                <li><a class="nav_on" id="mynav5"  href="goods/SelGoodByType/乌龙茶/1"><span>臧芝堂</span></a></li>
                <li><a class="nav_on" id="mynav6"  href="goods/SelGoodByType/乌龙茶/1"><span>大巴山茶</span></a></li>
                <li><a class="nav_on" id="mynav7"  href="goods/SelGoodByType/乌龙茶/1"><span>达州（茶）</span></a></li>
            ...
            <div class="image_display">
                ...
                <div class="slider">
                    <div id="slideBox" class="slideBox">
                        ...
                        <div class="bd">
                            <ul>
                                <li><a href="#" target="_self"><img src="images/ad-1.png" /></a></li>
                                <li><a href="#" target="_self"><img src="images/ad-3.jpg" /></a></li>
                            </ul>
                        </div>
