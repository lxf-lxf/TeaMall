...
<%@ page import="com.mall.entity.Adress" %>
            ...
            $(document).ready(function(){
                $("#UpdateAdress").click(function(){
                    ...
                    if (!onsub()){
                        ...
                        var adname=$("input[name='adname']").val();var province=$("#select_prov option:selected").val();
                        ...
                        $.post(
                            "adress/UpdateAdress",
                            {"adname":adname,"aid":aid,"province":province,"city":city,
                                "area":area,"detadress":detadress,"phone":phone,"postcode":postcode},
                            function (data) {
                                if (data == 1){
                                    swal({title:"",text:"修改地址成功！",type:"success"},
                                        function (){
                                            location.href="adress/selByPageNum/1";
                                        });
                                }else{
                                    swal("","修改地址失败,请联系管理员","error")
                                }
                            }
                        )
                    }
                        ...
                        <div class="user_layout">
                            <ul>
                                <li class="li"><label class="user_title_name">收件人姓名：</label>
                                    <input name="adname" type="text" onblur="checkadname()" class="add_text" value="${adress.adname}"><i>*</i>
                                ...
                                <li class="li">
                                    ...
                                    <span ><label> 省份 </label>
                                        ...
                                        <script>
                                            addressInit("select_prov","select_city","select_area","${adress.province}","${adress.city}","${adress.area}")
                                        </script>
                                    </div>
                                </li >
                                <li class="li"><label class="user_title_name">收货地址：</label>
                                    <input name="detadress" type="text" class="add_text" onblur="checkdetadress()" value="${adress.detadress}">
                                    <span id="Span_detadress"></span>
                                </li>
                                <li class="li"><label class="user_title_name">邮&nbsp;&nbsp;&nbsp;&nbsp;编：</label>
                                    <input name="postcode" maxlength="8" type="tel" class="add_text" onblur="checkpostcode()" value="${adress.postcode}" oninput = "value=value.replace(/[^\d]/g,'')">
                                    <i>*</i><span id="Span_postcode"></span>
                                </li>
                                <li class="li"><label class="user_title_name">手&nbsp;机&nbsp;号：</label>
                                    <input name="phone" maxlength="11" type="tel" class="add_text" onblur="checkphone()" value="${adress.phone}" oninput = "value=value.replace(/[^\d]/g,'')">
                                    <i>*</i><span id="Span_phone"></span>
                                </li>
                            </ul>
                            <div class="operating_btn"><input id="UpdateAdress" type="submit" value="修改" class="submit—btn"></div>
                        </div>
            </div>
        </div>
    </div>
