    ...
    <div class="clearfix user" >
        ...
        <div class="user_left">
            ...
            <ul class="Section">
                ...
                <li><a href="Orders"><em></em><span>我的订单</span></a></li>
        ...
        <div class="right_style r_user_style user_right">
            <div class="user_Borders">
                ...
                <div class="about_user_info">
                    <form id="form1" name="form1" method="post" action="user/updatePwd" onsubmit="return onSub('${user.password}')">
                        <div class="user_layout">
                            <ul >
                                <li><input name="uid" value="${user.uid}" style='display:none'/></li>
                                <li><label class="user_title_name">原密码：</label><input name="oldPwd" type="password"  class="add_text" id="oldPwd" onblur="checkPwd('${user.password}')"/><i>*</i><span id="oldSpan"></span> </li>
                                <li><label class="user_title_name">新密码：</label><input name="newPwd" type="password"  class="add_text" placeholder="密码要大于或者等于5位" id="newPass" onkeyup="checkPass()" /><i>*</i></li>
                                <li><label class="user_title_name">确认新密码：</label><input name="reNewPwd" type="password"  class="add_text" id="RenewPass" onkeyup="checkRe()"/><i>*</i></li>
                            </ul>
...
<script>
    ...
    function checkRe() {
        var pa1 = $("#newPass").val();
        var pa2 = $("#RenewPass").val();
        return pa1 === pa2;
    }

    function onSub(obj) {
        if(checkPass() && checkRe() && checkPwd(obj) ){
            return true;
        }else{
            return false;
        }
