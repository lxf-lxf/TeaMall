    ...
    <div class="Plates"  id="mian">
        ...
        <div class="Selling_list">
            <div id="slideBox_list" class="slideBox_list">
                ...
                <div class="bd">
                    <ul>
                        <c:forEach items="${goods}" var="good" varStatus="xh">
                            <c:if test="${xh.index<=4}">
                            <li class="s_Products">
                                <div class="Products_list_name">
                                    <div class="img center"><a href="goods/SelAllGoods"><img src="${good.photo}" /></a></div>
                                    <div class="title_name"><a href="goods/SelAllGoods">${good.gname}</a></div>
                    ...
                    <ul>
                        <c:forEach items="${goods}" var="good" varStatus="xh">
                            <c:if test="${xh.index>=5 and xh.index<=9}">
                            <li class="s_Products">
                                <div class="Products_list_name">
                                    <div class="img center"><a href="goods/SelAllGoods"><img src="${good.photo}" /></a></div>
                                    <div class="title_name"><a href="goods/SelAllGoods">${good.gname}</a></div>
                    ...
                    <ul>
                        <c:forEach items="${goods}" var="good" varStatus="xh">
                            <c:if test="${xh.index>=10 and xh.index<=14}">
                                <li class="s_Products">
                                    <div class="Products_list_name">
                                        <div class="img center"><a href="goods/SelAllGoods"><img src="${good.photo}" /></a></div>
                                        <div class="title_name"><a href="goods/SelAllGoods">${good.gname}</a></div>
        ...
        <div class="Area">
            ...
            <div class="Area_list clearfix">
                ...
                <div class="Area_p_list">
                    <ul>
                        <c:forEach items="${goods}" var="good" varStatus="xh">
                            <c:if test="${xh.index>=8 and xh.index<=15}">
                                <li class="s_Products">
                                    <div class="Products_list_name">
                                        <div class="img center"><a href="goods/SelAllGoods"><img src="${good.photo}" /></a></div>
                                        <div class="title_name"><a href="goods/SelAllGoods">${good.gname}</a></div>
        ...
        <div class="Area">
            ...
            <div class="Area_list clearfix">
                ...
                <div class="Area_p_list">
                    <ul>
                        <c:forEach items="${goods}" var="good" varStatus="xh">
                            <c:if test="${xh.index>=16 and xh.index<=23}">
                                <li class="s_Products">
                                    <div class="Products_list_name">
                                        <div class="img center"><a href="goods/SelAllGoods"><img src="${good.photo}" /></a></div>
                                        <div class="title_name"><a href="goods/SelAllGoods">${good.gname}</a></div>
